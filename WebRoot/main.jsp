...
<%-- 	<span style="float:right; padding-right:20px;" >管理员:${sessionScope.adminLogin.adminName} <a href="admin_exitLogin.action" ><font color="white">，注销</font></a></span> --%>
	...
	<div data-options="region:'west',title:'导航菜单',split:true" style="width:200px;">
		...
		<div id="menu" class="easyui-accordion" data-options="fit:true">
			<div title="数据显示" >
            <ul>
              <li><a href="#" title="send_mainData_query.action">开奖数据查询</a></li>
              <li><a href="#" title="">近10期数据统计</a></li>
			...
			<div title="报表显示" >
            <ul>
              <li><a href="#" title="">按期段统计号码出现次数</a></li>
              <li><a href="#" title="">遗漏统计数据</a></li>
              <li><a href="#" title="">遗漏值统计数据</a></li>
              <li><a href="#" title="">后区号码组合统计数据</a></li>
             </ul>
			</div>
